...
namespace Portfolio.Controllers
{
    public class ImagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ImageId,ImageName,ProjectId")] Image image)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ImageId,ImageName,ProjectId")] Image image)
        {
            if (ModelState.IsValid)
            {
